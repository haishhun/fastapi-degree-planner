...
def test_stats_returns_200(
    client, auth_headers, seed_degree_requirement, registered_user
):
...
def test_stats_response_has_required_fields(
    client, auth_headers, seed_degree_requirement
):
    res = client.get("/api/v1/stats/", headers=auth_headers)
    data = res.json()
    expected_keys = [
        ...
        "cs_credits_done",
        "cs_credits_required",
        "cs_credits_remaining",
        "gpa_cumulative",
        "gpa_cs_only",
        "est_graduation",
        "liberal_arts_credits",
    ]
...
def test_stats_no_courses_full_credits_remaining(
    client, auth_headers, seed_degree_requirement
):
    res = client.get("/api/v1/stats/", headers=auth_headers)
    data = res.json()
...
def test_stats_completed_credits_counted(
    client,
    auth_headers_cs,
    registered_user_cs,
    seed_all_courses,
    seed_degree_requirement,
    db,
):
...
def test_stats_in_progress_credits_counted(
    client,
    auth_headers_cs,
    registered_user_cs,
    seed_all_courses,
...
def test_stats_planned_courses_not_counted(
    client,
    auth_headers_cs,
    registered_user_cs,
    seed_all_courses,
...
def test_stats_gpa_cumulative_correct(
    client,
    auth_headers_cs,
    registered_user_cs,
    seed_all_courses,
...
def test_stats_gpa_cs_only_correct(
    client,
    auth_headers_cs,
    registered_user_cs,
    seed_all_courses,
...
def test_stats_in_progress_does_not_affect_gpa(
    client,
    auth_headers_cs,
    registered_user_cs,
    seed_all_courses,
    ...
    enroll(
        db, registered_user_cs["id"], csci2, StatusEnum.in_progress, credits_applied=3
    )
...
def test_stats_gpa_zero_when_no_completed(
    client,
    auth_headers_cs,
    registered_user_cs,
    seed_all_courses,
...
def test_stats_cs_credits_only_counts_csci_courses(
    client,
    auth_headers_cs,
    registered_user_cs,
    seed_all_courses,
...
def test_stats_cs_credits_includes_in_progress(
    client,
    auth_headers_cs,
    registered_user_cs,
    seed_all_courses,
...
def test_stats_degree_progress_pct(
    client,
    auth_headers_cs,
    registered_user_cs,
    seed_all_courses,
...
def test_stats_credits_remaining(
    client,
    auth_headers_cs,
    registered_user_cs,
    seed_all_courses,
...
def test_stats_liberal_arts_credits(
    client,
    auth_headers_cs,
    registered_user_cs,
    seed_all_courses,
...
def test_stats_no_degree_requirement_falls_back_to_120(
